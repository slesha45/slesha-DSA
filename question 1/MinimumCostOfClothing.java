...
public class MinimumCostOfClothing {
    public static int findMinimumCost(int[][] price) {
        ...
        int minCost1 = price[0][0]; // Minimum cost when person 1 wears clothing option 1
        int minCost2 = price[0][1]; // Minimum cost when person 1 wears clothing option 2
        int minCost3 = price[0][2]; // Minimum cost when person 1 wears clothing option 3
        ...
        for (int i = 1; i < N; i++) {
            ...
            // Calculate the minimum cost for person i wearing each clothing option
        ...
        // Return the overall minimum cost by selecting the minimum among the three options
